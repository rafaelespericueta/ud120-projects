...
# r^2
#print 'training r^2 score = ', reg.score(feature_train, target_train)
print 'testing r^2 score = ', reg.score(feature_test, target_test)
'''
...
# Next 2 lines added as per final slide in lesson 6.
